<template>
  <div id="brrowListPrint" class="printContent">
    ...
    <div class="line"></div>
    <el-table
      :data="this.$store.state.res.handleSelectionChange"
      border
      style="width: 100%"
  ...
  export default {
    ...
    methods: {
      ...
      getBarcode: _.debounce(function () {
        ...
        JsBarcode("#jsBarcode", this.$store.state.res.handleSelectionChange[0].borrow_no, options);//原生
      }, 1000),
      printBorcodeList: _.debounce(function () {
        ...
        this.$store.state.res.handleSelectionChange=[]
